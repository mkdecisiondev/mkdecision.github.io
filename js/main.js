...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(273) ], __WEBPACK_AMD_DEFINE_RESULT__ = (function() {
	"use strict";
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__views_index_js__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_components_sidenav_js__ = __webpack_require__(310);

// import initCcos from '../../views/ccos.js';


Object(__WEBPACK_IMPORTED_MODULE_1__views_components_sidenav_js__["a" /* default */])(document.getElementById('sidenavMenu'), document.getElementById('leftSidenavToggle'), document.getElementById('rightSidenavToggle'));
...
/* if (window.pageId === 'ccos') {
	initCcos(
		...
		document.querySelectorAll('.step-text')
	);
} */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_bootstrap_js_src_modal_js__ = __webpack_require__(269);
...
function initIndex(options) {
	experianModal = new __WEBPACK_IMPORTED_MODULE_0__node_modules_bootstrap_js_src_modal_js__["a" /* default */](options.experianDialogNode);
	experianLogoNode = options.experianLogoNode;
	rsiModal = new __WEBPACK_IMPORTED_MODULE_0__node_modules_bootstrap_js_src_modal_js__["a" /* default */](options.rsiDialogNode);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util__ = __webpack_require__(309);
